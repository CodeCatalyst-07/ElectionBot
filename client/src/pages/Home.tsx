...
/**
 * Renders the Timeline Preview section showing a condensed election stage overview
 * with a link to the full timeline page.
 */
function TimelinePreviewSection(): JSX.Element {
  return (
...
/**
 * Renders the Google Calendar CTA banner allowing users to add Indian or US
 * election deadlines to their personal Google Calendar with one click.
 */
function CalendarCTA(): JSX.Element {
  return (
    <motion.div
