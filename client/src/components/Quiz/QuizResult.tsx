...
/**
 * Props passed to the badge/score header sub-section.
 */
...
/**
 * Renders the animated badge, score fraction, percentage bar, and action buttons
 * at the top of the quiz result screen.
 */
function ScoreHeader({ score, total, badge, percentage, onRestart, onShare }: ScoreHeaderProps): JSX.Element {
  return (
    <motion.div
...
/**
 * Renders the per-question answer review list showing correct/incorrect status
 * and the correct answer for any question the user got wrong.
 */
function AnswerReview({ questions, answers }: { questions: QuizQuestion[]; answers: QuizAnswer[] }): JSX.Element {
  return (
